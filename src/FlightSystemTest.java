...
class FlightSystemTest {
  ...
  void day_of_week_price() {
    ...
    assertEquals(FlightSystem.day_of_week_price(100.00, data), 110.00000000000001); //interpretacja wartości po przecinku przez Javę
  }
  ...
  void date_of_departure_price() {
    ...
    assertEquals(FlightSystem.date_of_departure_price(100.00, data1, data2), 120);
  }

  @org.junit.jupiter.api.Test
  void number_of_passengers_price() {
    assertEquals(FlightSystem.number_of_passengers_price(100.00, 70), 110.00000000000001); //interpretacja wartości po przecinku przez Javę
  }
}